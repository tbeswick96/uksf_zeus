...
def main():
    ...
    print("""
  #######################################
  # UKSF Development Environment Setup #
  #######################################

  This script will create your UKSF dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your UKSF project folder:
    [Arma 3 installation directory]\\{} => UKSF project folder
    P:\\{}                              => UKSF project folder
